...
export function NoteEditor({ userId }: { userId: string }) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-3 sm:px-4 md:px-8 py-6 sm:py-8">
      {/* Page Controls */}
      <div className="mb-6 sm:mb-8 space-y-4 sm:space-y-0">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900">My Pages</h2>
          <p className="text-xs sm:text-sm text-slate-600 mt-1">Organize your thoughts</p>
        </div>
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
          <select
            ...
            className="flex-1 sm:flex-none rounded-lg border border-slate-200 bg-white px-3 sm:px-4 py-2 text-xs sm:text-sm text-slate-900 outline-none transition-all focus:border-purple-500 focus:ring-2 focus:ring-purple-100"
          ...
          <button
            ...
            className="flex-1 sm:flex-none rounded-lg border border-slate-200 bg-white px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-slate-700 transition-all hover:bg-slate-50 hover:border-slate-300"
          >
          ...
          <button
            ...
            className="flex-1 sm:flex-none rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 px-4 sm:px-6 py-2 text-xs sm:text-sm font-medium text-white transition-all hover:shadow-lg hover:shadow-purple-500/25"
          >
      ...
      {/* Editor Container */}
      <div className="relative flex-1 rounded-2xl sm:rounded-3xl border border-slate-200 bg-white shadow-lg transition-all duration-200 overflow-hidden">
        {/* Toolbar Area */}
        <div
          className={[
            "border-b border-slate-200 transition-all duration-200 overflow-x-auto",
            isEditMode
